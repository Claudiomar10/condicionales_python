...
promedio = temperatura_total / 3
print()
print(f'La Suma de las temperaturas es igual a: {temperatura_total} grados')
print()
print(f'El Promedio de las Temperaturas ingresadas es: {promedio} grados')